...
class DaftarMutasiKeluargaScreen extends StatefulWidget {
  ...
  State<DaftarMutasiKeluargaScreen> createState() =>
      _DaftarMutasiKeluargaScreenState();
}

class _DaftarMutasiKeluargaScreenState
    extends State<DaftarMutasiKeluargaScreen> {
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  await context.push(
                                      '/detail-mutasi-keluarga/${m["mutasi_id"]}');
                                  _refresh();
                                },
                                borderRadius: BorderRadius.circular(12),
                                child: Padding(
                                      ...
                                      if (canManage)
                                        PopupMenuButton<String>(
                                          ...
                                          onSelected: (value) async {
                                            if (value == 'edit') {
                                              await context.push(
                                                  '/edit-mutasi-keluarga/${m["mutasi_id"]}');
                                              _refresh();
