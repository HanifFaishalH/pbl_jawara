...
class FormPengeluaran extends StatefulWidget {
  ...
  const FormPengeluaran({super.key, this.data});
...
class _FormPengeluaranState extends State<FormPengeluaran> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (widget.data == null) {
        await FinanceService.createPengeluaran(payload);
      } else {
        final id = widget.data!['pengeluaran_id'] as int;
        await FinanceService.updatePengeluaran(id, payload);
      }
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(widget.data == null ? 'Pengeluaran berhasil ditambah' : 'Pengeluaran berhasil diubah'),
